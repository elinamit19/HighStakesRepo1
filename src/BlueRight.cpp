...
RightMotor3.spinFor(reverse, 34.697, degrees, 275, rpm, false); 
LeftMotor1.spinFor(reverse, 34.697, degrees, 275, rpm, false); 
LeftMotor2.spinFor(reverse, 34.697, degrees, 275, rpm, false); 
LeftMotor3.spinFor(forward, 34.697, degrees, 275, rpm, true);
...
RightMotor3.spinFor(reverse, 534.697, degrees, 275, rpm, false); 
LeftMotor1.spinFor(reverse, 534.697, degrees, 275, rpm, false); 
LeftMotor2.spinFor(reverse, 534.697, degrees, 275, rpm, false); 
LeftMotor3.spinFor(forward, 534.697, degrees, 275, rpm, true);
